...
# consumokwh = float(input('Insira o valor do consumo médio: '))
# custo_disponibilidade = float(input('Insira o custo de disponibilidade: '))
...
ap = Presentation("APRESENTAÇÃO GD.pptx")
        ...
        if shape.shape_type == 17:  # 17 representa "Text Box"
            if shape.has_text_frame:
                ...
                if text.startswith("PROPOSTA PARA"): #OK
                    ...
                    atualizar_texto_shape_proposta(shape, texto1="Proposta de energia por assinatura:", texto2=texto_atualizado, fonte1="Arial", tamanho1=18, fonte2="Arial Bold", tamanho2=18)
                    ...
                    print('entrou consumo medio')
                    texto_atualizado = f"Para simulação foi considerando o consumo médio de {consumokwh:,.0f} kWh/mês".replace(",", "X").replace(".", ",").replace("X", ".")
